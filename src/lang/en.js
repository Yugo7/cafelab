export default {
    ...
    home: {
        ...
        checkOutOurSubscription1: "CHECK OUT OUR SUBSCRIPTIONS!",
        checkOutOurSubscription2: "HAVE THE BEST OF CAFELAB AT YOUR HOME EVERY MONTH!",
    ...
    giftCard: {
        ...
        motto: "Gift the ones you love with a gift card CafeLab!",
        selectAmount: "Select the value of your Gift Card:",
        customAmount: "Custom amount",
        enterCustomAmount: "How much would you like to gift?",
        selectPlaceholder: "Select the value of your Gift Card:",
        purchase: "Purchase",
    },
    modalQuiz: {
        newHere: "New around?",
    ...
    unsubscribe: {
        ...
        emailLabel: "Email",
        emailPlaceholder: "Enter your email",
        reasonLabel: "Reason for unsubscribing",
        reason1: "Too many emails",
        reason2: "Content not relevant",
        reason3: "Other",
        commentsLabel: "Additional comments",
        commentsPlaceholder: "Enter your comments",
        submitButton: "Unsubscribe",
        toast: {
            unsubscriptionSuccessTitle: "Unsubscription successful.",
            unsubscriptionSuccessDescription: "You have been unsubscribed from the newsletter.",
            unsubscriptionFailedTitle: "Unsubscription failed.",
            unsubscriptionFailedDescription: "Failed to unsubscribe. Please try again."
        }
    },
    orderModal: {
        ...
        productPeriodicity: "Periodicity",
        viewReceipt: "View Receipt",
        closeButton: "Close"
    },
    toast: {
        subscriptionSuccessTitle: "Subscription successful.",
        subscriptionSuccessDescription: "You have been subscribed to the newsletter.",
